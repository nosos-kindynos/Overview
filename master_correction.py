...
for source in people:
    for person in people:
        if (source, person) not in combos and (person, source) not in combos:

            if person!=source:
                combos.append((source,person))
...
dominancy_values=dominancy(people,list_of_first_degree_connections,risk_mapping)
